    ...
    affine.for %arg0 = 0 to 2 {
      affine.for %arg1 = 0 to 8 {
        affine.for %arg2 = 0 to 8 {
          %0 = affine.load %alloc_7[%arg0, %arg1, %arg2] : memref<2x8x8xf64>
          %1 = affine.load %alloc_6[%arg0, %arg1, %arg2] : memref<2x8x8xf64>
          %2 = arith.addf %0, %1 : f64
          affine.store %2, %alloc[%arg0, %arg1, %arg2] : memref<2x8x8xf64>
        }
      }
    }
    // toy.print %alloc : memref<2x8x8xf64>
