...
@constant_1 = private constant [8 x double] [double 1.100000e+00, double 2.400000e+00, double 4.700000e+00, double 1.300000e+00, double 1.000000e+00, double 2.100000e+00, double 2.300000e+00, double 7.200000e+00]
@constant_0 = private constant [8 x double] [double 1.300000e+00, double 2.600000e+00, double 4.200000e+00, double 1.100000e+00, double 1.900000e+00, double 2.200000e+00, double 2.500000e+00, double 7.700000e+00]
...
define void @main() {
  %1 = call ptr @malloc(i64 ptrtoint (ptr getelementptr (double, ptr null, i64 8) to i64))
  ...
  %5 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %4, i64 8, 3, 0
  %6 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %5, i64 1, 4, 0
  %7 = call ptr @malloc(i64 ptrtoint (ptr getelementptr (double, ptr null, i64 8) to i64))
  ...
  %11 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %10, i64 8, 3, 0
  %12 = insertvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %11, i64 1, 4, 0
  %13 = call ptr @malloc(i64 ptrtoint (ptr getelementptr (double, ptr null, i64 8) to i64))
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr %21, ptr @constant_0, i64 mul (i64 ptrtoint (ptr getelementptr (double, ptr null, i32 1) to i64), i64 8), i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr %24, ptr @constant_1, i64 mul (i64 ptrtoint (ptr getelementptr (double, ptr null, i32 1) to i64), i64 8), i1 false)
  br label %25
...
28:                                               ; preds = %25
  ...
  %34 = load <4 x double>, ptr %33, align 8
  %35 = fadd <4 x double> %31, %34
  %36 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %6, 1
  %37 = getelementptr double, ptr %36, i64 %26
  store <4 x double> %35, ptr %37, align 8
  %38 = add i64 %26, 4
  br label %25
