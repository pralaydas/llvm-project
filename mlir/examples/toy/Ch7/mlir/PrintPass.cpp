//===- PrintPass.cpp - Passes to illustrate the IR def-use chains ---===//
//
...
//===----------------------------------------------------------------------===//
// Include header file for Other dialect
//===----------------------------------------------------------------------===//
...
struct LowerPrintPass
  ...
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(LowerPrintPass)
...
std::unique_ptr<mlir::Pass> mlir::poseidon::createPrintPass() {
